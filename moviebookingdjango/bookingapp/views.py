...
from bookingapp.forms import CreateMovieForm
from rest_framework.exceptions import PermissionDenied
from datetime import datetime
from bookingapp.models import BookingRegister
...
def accept_booking(request, pk):
    ...
    if serializer.is_valid():
        ...
        from_email = 'anarghamohan@admin.com'
...
razorpay_client = RazorpayClient(auth=("rzp_test_UjHhAk44JEp4HG", "pOHrNJgstn4WUWYBckSpeCaY"))
    ...
    if request.method == "POST":
        try:
            ...
            response_data = {
                ...
                "razorpay_key": "rzp_test_UjHhAk44JEp4HG",
